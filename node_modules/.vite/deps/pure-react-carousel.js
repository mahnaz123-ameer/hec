...
var _excluded$3 = ["carouselStore", "className", "currentSlide", "disabled", "onClick", "totalSlides", "visibleSlides"];
var _class$2;
var ButtonLast = (_class$2 = function(e2) {
  function t() {
    var e3;
    return _classCallCheck(this, t), e3 = r.call(this), e3.handleOnClick = e3.handleOnClick.bind(_assertThisInitialized(e3)), e3;
  }
  ...
  return _createClass(t, [{ key: "handleOnClick", value: function(e3) {
    ...
    var e3 = this.props, t2 = (e3.carouselStore, e3.className), r2 = e3.currentSlide, i = e3.disabled, n = (e3.onClick, e3.totalSlides), s2 = e3.visibleSlides, o = _objectWithoutProperties(e3, _excluded$3), a = cn([s$2.buttonLast, "carousel__last-button", t2]), l = null !== i ? i : r2 >= n - s2;
...
}(import_react.default.Component), _defineProperty(_class$2, "propTypes", { carouselStore: propTypes.object.isRequired, children: CarouselPropTypes.children.isRequired, className: propTypes.string, currentSlide: propTypes.number.isRequired, disabled: propTypes.bool, onClick: propTypes.func, totalSlides: propTypes.number.isRequired, visibleSlides: propTypes.number.isRequired }), _defineProperty(_class$2, "defaultProps", { className: null, disabled: null, onClick: null }), _class$2);
var index$2 = WithStore(ButtonLast, function(e2) {
...
var _excluded$4 = ["carouselStore", "className", "currentSlide", "disabled", "onClick", "step", "totalSlides", "visibleSlides", "infinite"];
var _class$3;
var ButtonNext = (_class$3 = function(e2) {
  function t(e3) {
    var i;
    return _classCallCheck(this, t), i = r.call(this, e3), i.handleOnClick = i.handleOnClick.bind(_assertThisInitialized(i)), i;
  }
  ...
  return _createClass(t, [{ key: "handleOnClick", value: function(e3) {
    ...
    var e3 = this.props, r2 = (e3.carouselStore, e3.className), i = e3.currentSlide, n = e3.disabled, s2 = (e3.onClick, e3.step, e3.totalSlides), o = e3.visibleSlides, a = e3.infinite, l = _objectWithoutProperties(e3, _excluded$4), c = cn([s$3.buttonNext, "carousel__next-button", r2]), u = t.setDisabled(n, i, o, s2, a);
...
}(import_react.default.PureComponent), _defineProperty(_class$3, "propTypes", { carouselStore: propTypes.object.isRequired, children: CarouselPropTypes.children.isRequired, className: propTypes.string, currentSlide: propTypes.number.isRequired, disabled: propTypes.bool, onClick: propTypes.func, step: propTypes.number.isRequired, totalSlides: propTypes.number.isRequired, visibleSlides: propTypes.number.isRequired, infinite: propTypes.bool }), _defineProperty(_class$3, "defaultProps", { className: null, disabled: null, onClick: null, infinite: false }), _class$3);
var index$3 = WithStore(ButtonNext, function(e2) {
  return { currentSlide: e2.currentSlide, step: e2.step, totalSlides: e2.totalSlides, visibleSlides: e2.visibleSlides, infinite: e2.infinite };
});
...
var ImageWithZoom = (_class$8 = function(e2) {
  ...
  return _createClass(t, [{ key: "componentDidUpdate", value: function(e3, t2) {
  ...
  } }, { key: "handleImageComplete", value: function(e3) {
    this.setState({ isImageLoading: false }), this.props && this.props.onLoad && this.props.onLoad(e3);
  } }, { key: "handleImageLoadError", value: function(e3) {
    this.setState({ isImageLoadingError: true, isImageLoading: false }), this.props && this.props.onError && this.props.onError(e3);
    ...
    var e3 = this.props, t2 = e3.alt, r2 = e3.bgImageProps, i = e3.bgImageTag, n = (e3.carouselStore, e3.className), s2 = e3.imageClassName, o = e3.overlayClassName, a = (e3.isPinchZoomEnabled, e3.spinner, e3.src), l = e3.srcZoomed, c = e3.tag, u = _objectWithoutProperties(e3, _excluded$a), p = cn([s$9.container, n]), d = cn([s$9.image, "carousel__zoom-image", s2]), h = cn([s$9.overlay, "carousel__zoom-image-overlay", this.state.isHovering && s$9.hover, this.state.isZooming && s$9.zoom, this.state.isHovering && "carousel__zoom-image-overlay--hovering", this.state.isZooming && "carousel__zoom-image-overlay--zooming", o]), y = {};
    return (this.state.isHovering || this.state.isZooming) && (y.transformOrigin = "".concat(this.state.x, " ").concat(this.state.y), y.transform = "scale(".concat(this.state.scale, ")")), import_react.default.createElement(c, _extends({ className: p }, u), import_react.default.createElement(Image$1, _extends({ alt: t2, className: d, tag: i, src: a, onLoad: this.handleImageComplete, onError: this.handleImageLoadError }, r2)), import_react.default.createElement(Image$1, { className: h, tag: "div", src: l || a, style: y, isBgImage: true, onFocus: this.handleOnMouseOver, onMouseOver: this.handleOnMouseOver, onBlur: this.handleOnMouseOut, onMouseOut: this.handleOnMouseOut, onMouseMove: this.handleOnMouseMove, onTouchStart: this.handleOnTouchStart, onTouchEnd: this.handleOnTouchEnd, onTouchMove: this.handleOnTouchMove }), this.renderLoading());
...
var _excluded$b = ["ariaLabel", "carouselStore", "children", "className", "classNameHidden", "classNameVisible", "currentSlide", "index", "innerClassName", "innerTag", "naturalSlideHeight", "naturalSlideWidth", "onBlur", "onFocus", "orientation", "slideSize", "style", "tag", "totalSlides", "visibleSlides", "isIntrinsicHeight"];
var _class$9;
...
var Slider = (_class$a = function(e2) {
  ...
  return _createClass(t, [{ key: "componentDidMount", value: function() {
    ...
    if (this.sliderTrayElement = e3, e3 && window) {
      var t2 = e3.closest(".carousel");
      t2 && (this.rtl = "rtl" === window.getComputedStyle(t2, null).getPropertyValue("direction"));
    }
    ...
    var r2 = this;
    window.cancelAnimationFrame.call(window, this.moveTimer), this.moveTimer = window.requestAnimationFrame.call(window, function() {
      r2.setState(function(i) {
        return { deltaX: (e3 - i.startX) * (r2.rtl ? -1 : 1), deltaY: t2 - i.startY, preventingVerticalScroll: Math.abs(t2 - i.startY) <= r2.props.verticalPixelThreshold && Math.abs(e3 - i.startX) >= r2.props.horizontalPixelThreshold };
      });
    });
    ...
    return import_react.default.createElement("div", _extends({ ref: function(t3) {
      e3.sliderElement = t3;
    }, className: P, "aria-live": "polite", "aria-label": r2, role: this.props.role, style: T, onKeyDown: this.handleOnKeyDown }, M), import_react.default.createElement("div", { className: E, style: k }, import_react.default.createElement(f, _extends({ ref: this.getSliderRef, className: w, style: C, onTouchStart: this.handleOnTouchStart, onTouchMove: this.handleOnTouchMove, onTouchEnd: this.handleOnTouchEnd, onTouchCancel: this.handleOnTouchCancel, onMouseDown: this.handleOnMouseDown, onClickCapture: this.handleOnClickCapture }, x), i), this.renderMasterSpinner()));
...
export {
  index as ButtonBack,
  ButtonBack as ButtonBackView,
  index$1 as ButtonFirst,
  ButtonFirst as ButtonFirstView,
  index$2 as ButtonLast,
  ButtonLast as ButtonLastView,
  index$3 as ButtonNext,
  ButtonNext as ButtonNextView,
  index$4 as ButtonPlay,
  ButtonPlay as ButtonPlayView,
  Context as CarouselContext,
  CarouselProvider,
  Dot$1 as Dot,
  index$5 as DotGroup,
  DotGroup as DotGroupView,
  Dot as DotView,
  Image$1 as Image,
  Image as ImageView,
  index$6 as ImageWithZoom,
  ImageWithZoom as ImageWithZoomView,
  index$7 as Slide,
  Slide as SlideView,
  index$8 as Slider,
  Slider as SliderView,
  Spinner,
