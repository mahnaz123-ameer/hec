  ...
  return (
    <>
      <div className="relative w-full hidden md:block">
        ...
        >
          <Combobox.Input
            className="w-full sm:w-[300px] md:w-[400px] lg:w-[500px] px-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-transparent bg-blue-100"
