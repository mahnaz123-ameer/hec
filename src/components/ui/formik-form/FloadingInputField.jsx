...
const FloadingInputField = ({ label, required, ...props }) => {
      ...
      <div class="flex mb-4">
        <div class="relative w-full border rounded-lg">
          <input
            type="text"
            id="eventTitle"
            class={`block rounded-t-lg px-2.5 pb-2.5 pt-5 w-full text-sm border-0appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer bg-transparent ${
...
export default FloadingInputField;
